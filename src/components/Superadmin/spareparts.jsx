...
export default function SparePartsInventory() {
  ...
  const vendorNames = useMemo(
    () =>
      Array.from(new Set(items.map((i) => i.vendor?.name).filter(Boolean))).sort(),
    [items],
  );
                          ...
                          <div key={loc.id} className="p-4">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-2 text-xs">
                              <div>
                                ...
                                <p className="font-bold text-gray-900">{loc.quantity}</p>
                              </div>
                              <div>
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              <div>
                ...
                <SearchableDropdown
                  ...
                  onSelect={(val, label) =>
                    setForm((f) => ({ ...f, vendor: val, vendorName: label }))
                  }
              ...
              <div>
                ...
                <SearchableDropdown
                  ...
                  options={locations}
                  onSelect={(val) =>
                    setForm((f) => ({ ...f, location: val, locationDisplay: val }))
                  }
          ...
          <div className="bg-white p-5 sm:p-6 rounded-2xl w-full max-w-md border border-gray-200 shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  <p className="text-gray-400 text-xs mb-0.5">Current Location</p>
