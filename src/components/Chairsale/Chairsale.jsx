...
const ChairSales = () => {
    ...
    return enrichedSales
      .filter((s) => {
        const matchSearch =
          ...
          s.chair.toLowerCase().includes(search.toLowerCase()) ||
  ...
  }, [search, selectedType, selectedPriority]);
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = "chair-sales-report.csv";
    a.click();
  };
        ...
        <div className="bg-neutral-800 border-b border-neutral-700 mb-8 p-4 flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-sm text-neutral-400">
              Track chair sales orders, delivery timelines, billing,
              and order priority.
            </p>
          </div>
        ...
        <div className="flex flex-wrap gap-7 mb-6">
          <div className="relative max-w-md">
            ...
            <input
              ...
              placeholder="Search by order ID, chair, or client..."
          ...
          {[
            ["Type", selectedType, setSelectedType, ["All", "Executive", "Meeting", "Visitor", "Training"]],
            ["Priority", selectedPriority, setSelectedPriority, ["All", "High", "Medium", "Low"]],
              ...
              {filteredSales.map((s) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="text-white">{s.chair}</div>
