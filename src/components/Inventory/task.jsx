                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      ...
                      <th className="p-4 text-left font-semibold text-gray-700">Assigned On</th>
                  ...
                  <tbody>
                    {filteredTasks.map((t, index) => {
                      ...
                      return (
                        ...
                        >
                          <td className="p-4 font-medium text-gray-900">{t.task}</td>
                          <td className="p-4 text-gray-700">{formatDate(t.createdAt)}</td>
                          <td className="p-4 text-gray-700">{formatDate(t.dueAt)}</td>
