        ...
        <div className="sticky top-0 z-10 bg-white/80 backdrop-blur border-b border-gray-200 p-6 shadow-sm">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
              ...
              <span>My Warehouse Tasks</span>
            </h1>
            <p className="text-sm text-gray-600 mt-1">
              View and complete your assigned warehouse work
            </p>
          </div>
        </div>
            ...
            <div className="max-w-4xl bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                ...
                {task.status === "Completed" ? (
                  <span className="px-4 py-2 rounded-full bg-green-50 text-green-700 flex items-center gap-2 font-medium border border-green-200">
                    <CheckCircle size={18} /> Completed
                  </span>
                ) : (
                  <span className="px-4 py-2 rounded-full bg-amber-50 text-amber-700 flex items-center gap-2 font-medium border border-amber-200">
                    ...
                    {pastTasks.map((t, index) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-6">
                          <span className="px-3 py-1 bg-green-50 text-green-700 border border-green-200 rounded-full text-xs font-medium flex items-center gap-2 w-fit">
